...
class EspeciaisController extends AtributosController{
    ...
    async initVantsEDesvants(){
        ...
        testeDeEspecial(especial, categoria){
            let confirm = false
            if(this._availablePoints < especial.cost){
                confirm = false
            }
            else{
                if(Array.isArray(this.meusEspeciais[categoria]))
                    this.especais[categoria].forEach((espcCateg)=>{
                        if(espcCateg == especial){
                            confirm = false
                        }
                        else{
                            confirm = true
        ...
        insereEspecial(option, tabela){
            ...
            console.log(this.availablePoints,option.dataset.cost)
            this.meusEspeciais[name]= option.name;
            console.log(this.meusEspeciais, name)
        }
